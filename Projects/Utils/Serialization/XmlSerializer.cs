...
// XML serialization helper embedding assembly / type information for polymorphic round-trips.
...
public static class XmlSerializer
{
	...
	public static XmlElement? ToElement(Object? data, Type objectType, String xmlElementName = "", XmlWriterSettings? settings = null)
	{
		...
		// serialize with the same type that is recorded in the TypeName attribute,
		// otherwise deserialization would use a different serializer than serialization did
